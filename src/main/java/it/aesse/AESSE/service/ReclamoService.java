package it.aesse.AESSE.service;
            ...
            /**
             * Classe di servizio per la gestione delle entità Reclamo.
             */
            @Slf4j
            @Service
            public class ReclamoService extends AbstractService<Reclamo, ReclamoDto> {
                ...
                /**
                 * Recupera una lista di oggetti ReclamoDto in base ai criteri specificati.
                 *
                 * @param valore il valore per filtrare gli oggetti ReclamoDto
                 * @param controllo il criterio per filtrare gli oggetti ReclamoDto
