...
/**
 * Classe di servizio per la gestione delle entità Sinistro.
 */
@Slf4j
@Service
public class SinistroService extends AbstractService<Sinistro, SinistroDto>
{
    ...
    /**
     * Recupera una lista di SinistroDto per il dato polizzaId.
     *
     * @param polizzaId l'ID della polizza
     * @return una lista di SinistroDto associati al dato polizzaId
     */
    ...
    /**
     * Recupera una lista di SinistroDto per il dato stato.
     *
     * @param stato lo stato del sinistro
     * @return una lista di SinistroDto associati al dato stato
     */
    ...
    /**
     * Recupera una lista di SinistroDto per l'ID del cliente specificato.
     *
     * @param clienteId l'ID del cliente
     * @return una lista di SinistroDto associati all'ID del cliente specificato
     */
    ...
    /**
     * Calcola la somma dei danni per il dato polizzaId.
     *
     * @param polizzaId l'ID della polizza
     * @return la somma dei danni per il dato polizzaId
     */
    ...
    /**
     * Calcola la somma degli importi concessi per il dato polizzaId.
     *
     * @param polizzaId l'ID della polizza
     * @return la somma degli importi concessi per il dato polizzaId
     */
    ...
    /**
     * Genera un file Excel con i dettagli dei sinistri per il dato polizzaId.
     *
     * @param polizzaId l'ID della polizza
